...
export async function GET(req: NextRequest) {
  try { const s = await requireAuth(); const gid = req.nextUrl.searchParams.get("groupId") ?? undefined; return ok(await listOfficialAccounts(s.userId, gid)); } catch (e) { return ua(e) ?? (() => { throw e; })(); }
}
...
export async function DELETE(req: NextRequest) {
  ...
  catch (e) { if (e instanceof OfficialAccountNotFoundError) return err("NOT_FOUND", e.message, undefined, 404); return ua(e) ?? (() => { throw e; })(); }
}
