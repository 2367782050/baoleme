...
export async function GET() { try { const s = await requireAuth(); return ok(await listCommissions(s.userId)); } catch (e) { return ua(e) ?? err("INTERNAL_ERROR", "服务器内部错误", undefined, 500); } }
